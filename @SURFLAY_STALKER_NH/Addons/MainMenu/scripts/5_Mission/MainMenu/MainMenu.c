...
{	
	...
	bool LoadVideoFileDF()
	{
		...
		//CopyFile("MainMenu/data/MainMenuVideo.mp4", "$profile:MainMenuVideo.mp4");
		//CopyFile("MainMenu/data/MainMenuVideo.mp4", "$profile:MainMenuVideo.mp4");
		//int rnd = Math.RandomIntInclusive(0,1);
		//switch (rnd)
		//{
		//	case 0:{m_Video_DF.Load("$profile:MainMenuVideo.mp4", false);break;}
		//	case 1:{m_Video_DF.Load("$profile:MainMenuVideo.mp4", false);break;}
		//}

		CopyFile("MainMenu/data/MainMenuVideo.mp4", "$profile:MainMenuVideo.mp4");
		m_Video_DF.Load("$profile:MainMenuVideo.mp4", false);
